// Source-of-truth synced from web (frontend/trader/src/data/academy.ts).
// Mobile uses `quiz` as a flat array (web wraps it as { title, questions }).
// Adding `description` and per-module `level` so cards/lists match web parity.
